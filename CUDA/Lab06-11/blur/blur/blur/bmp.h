// code to write and read bmp files from
// github repository https://github.com/sol-prog/cpp-bmp-images
...
struct BMP {
    ...
    BMP(int32_t width, int32_t height, bool has_alpha = true, bool eight_bits = false) {
        if (width <= 0 || height <= 0) {
